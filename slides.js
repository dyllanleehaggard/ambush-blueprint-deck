...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto auto 1fr; gap: 2rem; padding: clamp(2.5rem, 4vw, 4.5rem) clamp(3rem, 5vw, 5rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div class="display display-lg" style="color: var(--paper);">Roster <span class="accent-teal">composition.</span></div>
        <div class="mono accent-mute">SQUAD SNAPSHOT · STRENGTHS · OPPORTUNITIES</div>
      </div>

      <!-- Roster snapshot strip: top-line stats -->
      <div class="rev d2" style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 0; border-top: 2px solid var(--paper); border-bottom: 2px solid var(--paper);">
        ${[
          ['18',     'PLAYERS ON ACTIVE ROSTER'],
          ['27.4',   'AVG AGE'],
          ['~6 YR',  'AVG TENURE OF CORE'],
          ['4',      'REGION 4 HOMEGROWN'],
          ['1',      'REIGNING MASL GK OF THE YEAR'],
        ].map(([big, label], i) => `
          <div style="border-left: ${i>0 ? '1px solid var(--rule)' : 'none'}; padding: 1.2rem 1rem; display: flex; flex-direction: column; gap: 0.4rem; align-items: center; text-align: center;">
            <div class="num-heavy" style="color: var(--teal); font-size: clamp(2rem, 3.5vw, 3rem); line-height: 0.85;">${big}</div>
            <div class="mono accent-mute" style="font-size: 9px; line-height: 1.3;">${label}</div>
          </div>
        `).join('')}
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2.5rem; align-items: start;">
        ...
        <!-- LEFT: Strengths -->
        <div class="rev d3" style="border-left: 3px solid var(--teal); padding-left: 1.8rem; display: flex; flex-direction: column; gap: 1.3rem;">
          <div>
            <div class="display display-md accent-teal" style="font-size: 1.6rem;">STRENGTHS</div>
            <div class="serif" style="color: var(--paper); font-style: italic; font-size: 1.1rem; line-height: 1.35; margin-top: 0.4rem;">Anchor performers carrying the tactical identity.</div>
          </div>

          <!-- Anchor players -->
          <div style="display: flex; flex-direction: column; gap: 1rem;">
            <div style="border-top: 1px solid var(--rule); padding-top: 0.9rem;">
              <div style="display: flex; align-items: baseline; justify-content: space-between; gap: 1rem; margin-bottom: 0.3rem;">
                <div class="display" style="color: var(--paper); font-size: 1.3rem; letter-spacing: 0.03em;">PAULO NASCIMENTO</div>
                <div class="mono accent-teal" style="font-weight: 700;">GK · #1</div>
              </div>
              <div class="serif" style="color: var(--mute); font-size: 0.95rem; font-style: italic; line-height: 1.4;">
                2025-26 MASL Goalkeeper of the Year. Elite Six selection. 250 saves. 7th year in the shirt — the spine of the team and the league's most reliable shot-stopper.
              </div>
            </div>

            <div style="border-top: 1px solid var(--rule); padding-top: 0.9rem;">
              <div style="display: flex; align-items: baseline; justify-content: space-between; gap: 1rem; margin-bottom: 0.3rem;">
                <div class="display" style="color: var(--paper); font-size: 1.3rem; letter-spacing: 0.03em;">ESKAY</div>
                <div class="mono accent-teal" style="font-weight: 700;">ATT · CAPTAIN</div>
              </div>
              <div class="serif" style="color: var(--mute); font-size: 0.95rem; font-style: italic; line-height: 1.4;">
                Tactical anchor of the attack. The press trigger. Locker-room standard-setter and the face most fans recognize.
              </div>
            </div>
          </div>

          <!-- Squad-wide strengths -->
          <div style="border-top: 1px solid var(--rule); padding-top: 0.9rem;">
            <div class="mono accent-teal" style="font-weight: 700; margin-bottom: 0.7rem;">▸ SQUAD-WIDE</div>
            <div style="display: flex; flex-direction: column; gap: 0.55rem;">
              ${[
                'Goalkeeping unit — Paulo as starter, capable backup behind him',
                'Veteran spine running the press and set-piece structure',
                'Locally-rooted core — multiple players with St. Louis history',
                'Strong character, low-drama locker room',
                'Battle-tested through a deep playoff run',
              ].map(t => `
                <div style="display: grid; grid-template-columns: 12px 1fr; gap: 0.7rem; align-items: baseline;">
                  <div style="width: 6px; height: 6px; background: var(--teal); margin-top: 0.45rem;"></div>
                  <div class="serif" style="color: var(--paper); font-size: 0.95rem; font-style: italic; line-height: 1.35;">${t}</div>
                </div>
              `).join('')}
            </div>
          </div>
        ...
        <!-- RIGHT: Opportunities -->
        <div class="rev d4" style="border-left: 3px solid var(--pink); padding-left: 1.8rem; display: flex; flex-direction: column; gap: 1.3rem;">
          <div>
            <div class="display display-md accent-pink" style="font-size: 1.6rem;">OPPORTUNITIES</div>
            <div class="serif" style="color: var(--paper); font-style: italic; font-size: 1.1rem; line-height: 1.35; margin-top: 0.4rem;">Where the roster needs sharpening.</div>
          </div>

          <!-- Position-specific gaps -->
          <div style="border-top: 1px solid var(--rule); padding-top: 0.9rem;">
            <div class="mono accent-pink" style="font-weight: 700; margin-bottom: 0.7rem;">▸ POSITIONAL GAPS</div>
            <div style="display: flex; flex-direction: column; gap: 0.55rem;">
              ${[
                'Younger pace and verticality on the wings to threaten in transition',
                'A second creative #10 to relieve pressure on Eskay through a deep schedule',
                'Defensive depth — currently a starter\'s injury becomes a tactical re-shuffle',
                'A target forward profile for late-game chase-the-game scenarios',
              ].map(t => `
                <div style="display: grid; grid-template-columns: 12px 1fr; gap: 0.7rem; align-items: baseline;">
                  <div style="width: 6px; height: 6px; background: var(--pink); margin-top: 0.45rem;"></div>
                  <div class="serif" style="color: var(--paper); font-size: 0.95rem; font-style: italic; line-height: 1.35;">${t}</div>
                </div>
              `).join('')}
            </div>
          ...
          <!-- Structural gaps -->
          <div style="border-top: 1px solid var(--rule); padding-top: 0.9rem;">
            <div class="mono accent-pink" style="font-weight: 700; margin-bottom: 0.7rem;">▸ STRUCTURAL GAPS</div>
            <div style="display: flex; flex-direction: column; gap: 0.55rem;">
              ${[
                'No tactical fit matrix — every roster slot scored against the playbook',
                'No formal advancement criteria connecting USL 2 → MASL roster',
                'No documented retirement / aging-curve plan for the veteran core',
                'No pipeline from FC Ambush youth feeding into senior roster spots',
              ].map(t => `
                <div style="display: grid; grid-template-columns: 12px 1fr; gap: 0.7rem; align-items: baseline;">
                  <div style="width: 6px; height: 6px; background: var(--pink); margin-top: 0.45rem;"></div>
                  <div class="serif" style="color: var(--paper); font-size: 0.95rem; font-style: italic; line-height: 1.35;">${t}</div>
...
/* ============================================================
   21a — DYLLAN'S RECRUITMENT ROLE. Cross-MASL scouting contributions.
   ============================================================ */
SLIDES.push({
  section: 'PART II · SPORTING',
  title: 'Recruitment · My Role',
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART II · RECRUITMENT · MY ROLE')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <span class="chip teal">FUTURE · DYLLAN'S CONTRIBUTION</span>
          <div class="display display-lg" style="color: var(--paper); margin-top: 1rem;">How I help with <span class="accent-teal">recruitment.</span></div>
        </div>
        <div class="mono accent-mute" style="text-align: right;">MASL · MASL 2 · MASL 3 · USL 2</div>
      </div>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">

        <!-- LEFT: Build the database and pipeline -->
        <div class="rev d2" style="border-left: 4px solid var(--teal); padding: 0 0 0 2rem;">
          <div class="display accent-teal" style="font-size: 1.6rem; letter-spacing: 0.05em; margin-bottom: 1.3rem;">▸ BUILD THE PIPELINE</div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['CROSS-LEAGUE DATABASE',
                'A single Ambush-owned database of every meaningful player across MASL, MASL 2, MASL 3, and USL 2. Stats, video clips, contract status, agent contact, scouting notes — searchable by position, age, and fit.'],
              ['VIDEO LIBRARY',
                'Hudl-ready clip libraries on every name worth tracking. Rolling 90-day refresh. Donnie sees three cuts on a player before he ever has to dig for them.'],
              ['PERFORMANCE FLAGS',
                'Automated weekly report flagging breakout performers — top scorers, surprise +/- swings, GK spikes. We catch them before the rest of the league does.'],
              ['ASSIST AT TRYOUTS',
                'USL 2 tryouts already use my scoring system. Same approach scales to first-team open evaluations and Vetta tournament scouting.'],
            ].map(([k, v]) => `
              <div style="padding: 1rem 0; border-top: 1px solid var(--rule);">
                <div class="display" style="color: var(--paper); font-size: 1.05rem; letter-spacing: 0.04em; margin-bottom: 0.4rem;">${k}</div>
                <div class="serif" style="color: var(--mute); font-size: 0.95rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
        ...
        <!-- RIGHT: Scout on the ground -->
        <div class="rev d3" style="border-left: 4px solid var(--pink); padding: 0 0 0 2rem;">
          <div class="display accent-pink" style="font-size: 1.6rem; letter-spacing: 0.05em; margin-bottom: 1.3rem;">▸ COVER GROUND</div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['LIVE SCOUTING',
                'Cover MASL 2 and MASL 3 home games within driving distance. Two scouting trips per month minimum. Notes filed in the database same night.'],
              ['VETTA TOURNAMENTS',
                'Every Vetta event becomes a scouting weekend. Top performers tagged in real time through the partnership platform. Local talent flagged early.'],
              ['COLLEGE PIPELINE',
                'Build relationships with SLU, Webster, Lindenwood, Maryville, and Fontbonne men\'s programs. Watch their seasons. Identify USL 2 and pro fits before graduation.'],
              ['REPORT FORMAT',
                'Standardized one-page scouting report for every player — fit, ceiling, signing window, comp salary range. Donnie gets a deck, not a dump.'],
            ].map(([k, v]) => `
              <div style="padding: 1rem 0; border-top: 1px solid rgba(255,61,110,0.25);">
                <div class="display" style="color: var(--paper); font-size: 1.05rem; letter-spacing: 0.04em; margin-bottom: 0.4rem;">${k}</div>
                <div class="serif" style="color: var(--mute); font-size: 0.95rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
            <div style="border-top: 1px solid rgba(255,61,110,0.25);"></div>
          </div>
        </div>

      </div>

      <div class="rev d6" style="border-top: 2px solid var(--teal); padding-top: 1.2rem;">
        <div class="serif" style="color: var(--paper); font-size: 1.25rem; font-style: italic; text-align: center; line-height: 1.35;">
          Donnie owns the call. I make sure he never has to <span class="accent-teal" style="font-style: normal; font-weight: 600;">make it without the data.</span>
        </div>
      </div>
    </div>
  `
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto auto 1fr; gap: 1.6rem; padding: clamp(2rem, 3.5vw, 3.5rem) clamp(2.5rem, 4vw, 4.5rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div class="display display-lg" style="color: var(--paper);">Training. <span class="accent-pink">Periodized.</span></div>
        <div class="mono accent-mute">SAMPLE MONTH · DEC 2026</div>
      </div>

      <!-- Calendar: 7 columns (M-Sun), 4 weeks. Each cell = 1 day. -->
      <div class="rev d2" style="display: grid; grid-template-columns: 90px repeat(7, 1fr); gap: 4px; border-top: 2px solid var(--paper); padding-top: 1rem;">
        <!-- Header row -->
        <div></div>
        ${['MON','TUE','WED','THU','FRI','SAT','SUN'].map(d => `
          <div style="padding: 0.4rem; text-align: center;">
            <div class="mono accent-mute" style="font-size: 0.7rem; letter-spacing: 0.18em;">${d}</div>
          </div>
        `).join('')}

        ${[
          {
            label: 'WEEK 1',  sub: 'STANDARD',    color: 'var(--paper)',
            days: [
              ['REC',  'Off / film',          'var(--mute)'],
              ['TECH', 'Ball work',           'var(--paper)'],
              ['TAC',  'Peak — opp shape',    'var(--pink)'],
              ['ACT',  'Sharpness',           'var(--teal)'],
              ['PRE',  'Final prep',          'var(--paper)'],
              ['MATCH','vs Comets · 7pm',     'var(--pink)'],
              ['REC',  'Cold tub · off',      'var(--mute)'],
            ]
          },
          {
            label: 'WEEK 2',  sub: 'DOUBLE GAME WEEK',    color: 'var(--pink)',
            days: [
              ['REC+', 'Active recovery',     'var(--mute)'],
              ['LITE', 'Walk-through only',   'var(--teal)'],
              ['MATCH','at Wave · 7pm',       'var(--pink)'],
              ['REC',  'Travel + cold tub',   'var(--mute)'],
              ['LITE', 'Walk-through only',   'var(--teal)'],
              ['MATCH','vs Strykers · 7pm',   'var(--pink)'],
              ['REC',  'Full off',            'var(--mute)'],
            ]
          },
          {
            label: 'WEEK 3',  sub: 'STANDARD',    color: 'var(--paper)',
            days: [
              ['REC',  'Off / film',          'var(--mute)'],
              ['TECH', 'Ball work',           'var(--paper)'],
              ['TAC',  'Peak — set pieces',   'var(--pink)'],
              ['ACT',  'Sharpness',           'var(--teal)'],
              ['PRE',  'Final prep',          'var(--paper)'],
              ['MATCH','at Stars · 7pm',      'var(--pink)'],
              ['REC',  'Off',                 'var(--mute)'],
            ]
          },
          {
            label: 'WEEK 4',  sub: 'BYE WEEK',    color: 'var(--teal)',
            days: [
              ['OFF',  'Recovery week',       'var(--mute)'],
              ['LITE', 'Optional skills',     'var(--teal)'],
              ['STR',  'Strength block',      'var(--teal)'],
              ['DEV',  'Individual dev work', 'var(--teal)'],
              ['STR',  'Strength block',      'var(--teal)'],
              ['DEV',  'Player projects',     'var(--teal)'],
              ['OFF',  'Off',                 'var(--mute)'],
            ]
          },
        ].map(({ label, sub, color, days }) => `
          <div style="grid-column: 1; display: flex; flex-direction: column; justify-content: center; padding: 0 0.4rem; border-right: 1px solid var(--rule);">
            <div class="display" style="font-size: 0.95rem; color: ${color}; letter-spacing: 0.04em; line-height: 1;">${label}</div>
            <div class="mono" style="color: ${color}; opacity: 0.75; font-size: 0.6rem; margin-top: 0.25rem; letter-spacing: 0.15em;">${sub}</div>
          </div>
          ${days.map(([code, desc, dayColor]) => `
            <div style="border-left: 2px solid ${dayColor}; padding: 0.55rem 0.5rem; min-height: 60px; background: ${dayColor === 'var(--pink)' ? 'rgba(255,61,110,0.1)' : (dayColor === 'var(--teal)' ? 'rgba(0,184,169,0.07)' : 'rgba(244,241,234,0.025)')};">
              <div class="display" style="color: ${dayColor}; font-size: 0.8rem; letter-spacing: 0.05em; line-height: 1; margin-bottom: 0.3rem;">${code}</div>
              <div style="font-family: var(--f-body); color: var(--paper); font-size: 0.7rem; line-height: 1.3; opacity: 0.85;">${desc}</div>
            </div>
          `).join('')}
        `).join('')}
      </div>

      <!-- Catapult load chart row -->
      <div class="rev d4" style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 2rem; align-items: center; border-top: 1px solid var(--rule); padding-top: 1.2rem;">

        <!-- Chart -->
        <div style="background: rgba(244,241,234,0.03); padding: 1rem 1.2rem; border-left: 3px solid var(--pink);">
          <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 0.6rem;">
            <div class="mono" style="color: var(--pink); font-weight: 700; font-size: 0.78rem;">▸ CATAPULT LOAD CHART · 28-DAY</div>
            <div class="mono accent-mute" style="font-size: 0.65rem;">DISTANCE × INTENSITY · ARBITRARY UNITS</div>
          </div>
          <svg viewBox="0 0 600 110" style="width: 100%; height: 105px;" preserveAspectRatio="none">
            <!-- Reference baseline (chronic 4-wk avg) -->
            <line x1="0" y1="60" x2="600" y2="60" stroke="rgba(244,241,234,0.3)" stroke-width="1" stroke-dasharray="3 4"/>
            <!-- Week dividers -->
            ${[150, 300, 450].map(x => `<line x1="${x}" y1="0" x2="${x}" y2="110" stroke="rgba(244,241,234,0.12)" stroke-width="1"/>`).join('')}
            <!-- Load polygon area -->
            <path d="M 0,75 L 25,55 L 50,30 L 75,68 L 100,40 L 125,82 L 150,90 L 175,70 L 200,25 L 225,72 L 250,18 L 275,68 L 300,90 L 325,52 L 350,28 L 375,68 L 400,38 L 425,80 L 450,90 L 475,82 L 500,75 L 525,72 L 550,78 L 575,80 L 600,85 L 600,110 L 0,110 Z" fill="rgba(255,61,110,0.18)" stroke="none"/>
            <!-- Load polyline -->
            <polyline points="0,75 25,55 50,30 75,68 100,40 125,82 150,90 175,70 200,25 225,72 250,18 275,68 300,90 325,52 350,28 375,68 400,38 425,80 450,90 475,82 500,75 525,72 550,78 575,80 600,85" fill="none" stroke="#FF3D6E" stroke-width="2"/>
            <!-- Match-day markers -->
            ${[125, 250, 275, 375].map(x => `<circle cx="${x}" cy="${[82, 18, 68, 68][[125, 250, 275, 375].indexOf(x)]}" r="3.5" fill="#FF3D6E" stroke="#0A0A0A" stroke-width="1.5"/>`).join('')}
            <!-- Chronic baseline marker right -->
            <text x="595" y="56" fill="rgba(244,241,234,0.55)" font-family="JetBrains Mono" font-size="8" text-anchor="end">CHRONIC AVG</text>
          </svg>
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0.4rem; margin-top: 0.5rem;">
            ${['WEEK 1','WEEK 2 · 2 GAMES','WEEK 3','WEEK 4 · BYE'].map(t => `
              <div class="mono accent-mute" style="font-size: 0.62rem; text-align: center;">${t}</div>
            `).join('')}
          </div>
        </div>

        <!-- Right side: what the chart tells us -->
        <div>
          <div class="serif" style="font-size: 1.05rem; color: var(--paper); font-style: italic; line-height: 1.35; margin-bottom: 0.6rem;">
          ...
          <div style="display: flex; flex-direction: column; gap: 0.35rem; font-size: 0.78rem;">
            <div style="display: flex; gap: 0.6rem; align-items: baseline;">
              ...
              <span style="color: var(--paper); opacity: 0.85;">Match-day load spikes flagged in real time</span>
            </div>
            <div style="display: flex; gap: 0.6rem; align-items: baseline;">
              <span class="mono accent-mute">- - -</span>
              <span style="color: var(--paper); opacity: 0.85;">Chronic 4-wk baseline — the safe zone</span>
            </div>
            <div style="display: flex; gap: 0.6rem; align-items: baseline;">
              <span class="accent-teal" style="font-weight: 700;">▾</span>
              <span style="color: var(--paper); opacity: 0.85;">Bye-week recovery is structured, not improvised</span>
            </div>
          </div>
        </div>
      </div>
...
/* ============================================================
   28a — OPPOSITION ANALYTICS. Detailed seven-pillar breakdown.
   ============================================================ */
SLIDES.push({
  section: 'PART II · SPORTING',
  ...
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART II · OPPOSITION ANALYSIS')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <span class="chip teal">PROCESS · PRE-MATCH</span>
          <div class="display display-lg" style="color: var(--paper); margin-top: 1rem;">How I break down the <span class="accent-teal">opposition.</span></div>
        </div>
        <div class="mono accent-mute" style="text-align: right;">SEVEN PILLARS<br>EVERY MATCH</div>
      </div>

      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.3rem; align-content: center;">
        ${[
          ['01', 'BUILD-UP',
            'How they exit pressure from defensive third — playmaker preference, where the first pass goes, common shapes when uncontested vs. pressed.'],
          ['02', 'BALLS FROM THE KEEPER',
            'Direct restarts and goalkeeper distribution. Who they look for first, where the second ball usually lands, how often they go long vs. play short.'],
          ['03', 'SET PIECES · ALL ZONES',
            'Not just top-of-the-box. Sideline restarts, deep wide free kicks, corners, and indoor-specific kick-ins from every angle. Every set piece coded by zone.'],
          ['04', 'POWER PLAY · 6TH ATTACKER',
            'Their preferred attacking power-play structure. Where the 6th attacker drops in. What they look for first. The trigger that initiates their main pattern.'],
          ['05', 'DEFENDING POWER PLAY',
            'How they organize when shorthanded. Pressing triggers vs. drop-and-absorb. The man they rely on to take the long clearance.'],
          ['06', 'DEFENSIVE SHAPE IN PLAY',
            'Their default defensive shape — high block, mid-block, low block. Trigger players. Shape-shift moments by score state.'],
          ['07', 'TOP DEFENSIVE UNIT',
            'The pairing or trio that does the most defensive work. Who you isolate. Who you avoid. Who concedes fouls under pressure.'],
        ].map(([num, k, v]) => `
          <div style="border: 1px solid var(--rule); padding: 1.5rem; display: flex; flex-direction: column; gap: 0.8rem;">
            <div style="display: flex; align-items: baseline; justify-content: space-between;">
              <div class="display" style="color: var(--teal); font-size: 1.8rem; line-height: 0.9;">${num}</div>
              <div style="width: 30px; height: 2px; background: var(--teal);"></div>
            </div>
            <div class="display" style="color: var(--paper); font-size: 1.05rem; letter-spacing: 0.04em; line-height: 1.05;">${k}</div>
            <div class="serif" style="color: var(--mute); font-size: 0.9rem; font-style: italic; line-height: 1.4;">${v}</div>
          </div>
        `).join('')}

        <!-- 8th cell: deliverable -->
        <div style="border: 2px solid var(--teal); background: rgba(0,184,169,0.08); padding: 1.5rem; display: flex; flex-direction: column; gap: 0.6rem; justify-content: center;">
          <div class="mono accent-teal" style="font-weight: 700;">▸ THE DELIVERABLE</div>
          <div class="serif" style="color: var(--paper); font-size: 1rem; font-style: italic; line-height: 1.4;">
            One report. Distributed 72 hours pre-match. Tactical board, video clips, and a one-page summary the staff actually reads on the bus.
          </div>
        </div>
      </div>

      <div class="rev d8" style="border-top: 1px solid var(--rule); padding-top: 1.2rem;">
        <div class="serif" style="color: var(--paper); font-size: 1.2rem; font-style: italic; text-align: center; line-height: 1.35;">
          The opposition tells you exactly what they're going to do — <span class="accent-teal" style="font-style: normal; font-weight: 600;">if you build the framework to listen.</span>
        </div>
      </div>
    </div>
  `
...
/* ============================================================
   28b — OUR OWN FILM. Self-scout / honest reflection.
   ============================================================ */
SLIDES.push({
  section: 'PART II · SPORTING',
  title: 'Our Own Film',
  cls: 'bg-paper',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART II · SELF-SCOUT')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <div class="eyebrow accent-pink">PROCESS · SELF-SCOUT</div>
          <div class="display display-lg" style="color: var(--ink); margin-top: 0.5rem;">Breaking down <span class="accent-pink">our own</span> film.</div>
        </div>
        <div class="mono" style="color: var(--mute-deep); text-align: right;">A HONEST GAP I'M FIXING</div>
      </div>

      <div style="display: grid; grid-template-columns: 1fr 1.3fr; gap: 4rem; align-items: center;">

        <!-- LEFT: the honest reflection -->
        <div class="rev d2">
          <div class="serif" style="color: var(--ink); font-size: 1.9rem; font-style: italic; line-height: 1.25;">
            This past season I collected our data. I didn't <span class="accent-pink" style="font-style: normal; font-weight: 700;">break down</span> our film.
          </div>
          <div class="serif" style="color: var(--mute-deep); font-size: 1.15rem; font-style: italic; line-height: 1.4; margin-top: 1.5rem;">
            Opposition reports went deep. Our own play didn't get the same lens. That has to change — we have to look at ourselves the way we look at every team across the table.
          </div>
        </div>

        <!-- RIGHT: what self-scouting looks like -->
        <div class="rev d3">
          <div class="mono accent-pink" style="font-weight: 700; margin-bottom: 1.2rem;">▸ WHAT SELF-SCOUT LOOKS LIKE</div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['OUR BUILD-UP',          'The same seven-pillar framework, turned inward. Where do we lose the ball? Which restart routines stall?'],
              ['OUR SET PIECES',         'Are we tendencies? What does the league see when they prep us? Which deliveries are repeating without payoff?'],
              ['OUR POWER PLAY',         'What\'s our success rate by structure? Which 6th attacker drop creates the most chances? Time to first shot?'],
              ['OUR DEFENSIVE SHAPE',    'When does our high block break down? What do we concede on the counter? Which opposition profiles cause repeat trouble?'],
              ['CLIPS BY PLAYER',        'Every player gets a personal cut every two weeks — what they do well, what to clean up, ready before the next match.'],
              ['HONEST DEBRIEFS',        'Internal post-match report — wins and losses both — within 48 hours. The staff reads it, the players see the relevant pieces.'],
            ].map(([k, v]) => `
              <div style="display: grid; grid-template-columns: 200px 1fr; gap: 1.2rem; padding: 0.95rem 0; border-top: 1px solid rgba(10,10,10,0.18); align-items: baseline;">
                <div class="display" style="color: var(--pink); font-size: 1rem; letter-spacing: 0.04em;">${k}</div>
                <div class="serif" style="color: var(--ink); font-size: 1rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
            <div style="border-top: 1px solid rgba(10,10,10,0.18);"></div>
          </div>
        </div>

      </div>

      <div class="rev d6" style="background: var(--ink); color: var(--paper); padding: 1.4rem 2rem;">
        <div class="serif" style="font-size: 1.25rem; font-style: italic; text-align: center; line-height: 1.35;">
          You can't sharpen what you won't look at. <span class="accent-pink" style="font-style: normal; font-weight: 600;">The mirror is the cheapest tactical edge we have.</span>
        </div>
      </div>
    </div>
  `
...
/* ============================================================
   28c — CD CASTELLÓN SET-PIECE LEADERBOARD. Locker-room wall art idea.
   ============================================================ */
SLIDES.push({
  section: 'PART II · SPORTING',
  title: 'Set-Piece Leaderboard',
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART II · SET-PIECE LEADERBOARD')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <span class="chip teal">REFERENCE · CD CASTELLÓN</span>
          <div class="display display-lg" style="color: var(--paper); margin-top: 1rem;">A <span class="accent-teal">set-piece wall</span> they walk past every day.</div>
        </div>
        <div class="mono accent-mute" style="text-align: right;">LOW BUDGET · HIGH IMPACT</div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 3rem; align-items: center;">
        ...
        <!-- LEFT: the concept -->
        <div class="rev d2">
          <div class="serif" style="color: var(--paper); font-size: 1.5rem; font-style: italic; line-height: 1.3;">
            CD Castellón tracks every set piece on a <span class="accent-teal" style="font-style: normal; font-weight: 700;">leaderboard taped to a locker-room wall.</span> Score one, the team goes positive. Concede one, the team goes negative. Every team in the league listed. Personal tallies at the bottom.
          </div>
          <div class="serif" style="color: var(--mute); font-size: 1.1rem; font-style: italic; line-height: 1.4; margin-top: 1.3rem;">
            Players walk past it daily. They check it. They compete with it. The data isn't on a dashboard nobody opens — it's <span class="accent-teal" style="font-style: normal; font-weight: 600;">on the wall they live in.</span>
          </div>

          <div style="margin-top: 1.8rem; padding-top: 1.2rem; border-top: 1px solid var(--rule);">
            <div class="mono accent-pink" style="font-weight: 700; margin-bottom: 0.8rem;">▸ WHY IT WORKS FOR INDOOR</div>
            <div class="serif" style="color: var(--paper); font-size: 1.05rem; font-style: italic; line-height: 1.4;">
              Indoor lives on +/- and set pieces. Every kick-in, free kick, and corner is a scoring opportunity. A wall-tracked board makes the metric we already obsess over <span style="font-style: normal; font-weight: 700;">visible, social, and personal.</span>
            </div>
          </div>
        </div>

        <!-- RIGHT: my pitch -->
        <div class="rev d3" style="border: 2px solid var(--teal); background: rgba(0,184,169,0.06); padding: 2rem;">
          <div class="display accent-teal" style="font-size: 1.4rem; letter-spacing: 0.05em; margin-bottom: 1.2rem;">▸ HOW I'D BUILD IT</div>
          ${[
            ['LOCKER ROOM WALL',      'Magnetic tile system or peel-and-stick boards by team. Update by hand after every match. Tactile and low-tech on purpose.'],
            ['IPAD VERSION',           'A live, auto-updating leaderboard I can build today. Sync to Hudl coding tags or a Google Sheet — refresh by match.'],
            ['JUMBOTRON ROTATION',     'Rotating slide on game day showing the league standings of the wall. Fans see what the players see.'],
            ['PERSONAL TALLIES',       'Bottom of the wall: every player\'s set-piece +/-. Shooters, deliverers, defenders. Year-long competition for bragging rights.'],
            ['ZERO BUDGET TO START',   'Iteration one is print-at-home with athletic tape. Iteration two is a laminated reusable system. Iteration three is the screen build.'],
          ].map(([k, v]) => `
            <div style="display: grid; grid-template-columns: 14px 1fr; gap: 0.9rem; padding: 0.7rem 0; border-top: 1px solid rgba(0,184,169,0.25); align-items: baseline;">
              <div style="width: 8px; height: 8px; background: var(--teal); margin-top: 0.55rem;"></div>
              <div>
                <div class="display" style="color: var(--paper); font-size: 0.95rem; letter-spacing: 0.04em; margin-bottom: 0.3rem;">${k}</div>
                <div class="serif" style="color: var(--paper); font-size: 0.92rem; font-style: italic; line-height: 1.35; opacity: 0.85;">${v}</div>
              </div>
            </div>
          `).join('')}
        </div>
      ...
      <div class="rev d6" style="border-top: 2px solid var(--teal); padding-top: 1.2rem;">
        <div class="serif" style="color: var(--paper); font-size: 1.2rem; font-style: italic; text-align: center; line-height: 1.35;">
          The best analytics aren't in a report nobody reads. They're <span class="accent-teal" style="font-style: normal; font-weight: 600;">on a wall everybody walks past.</span>
        </div>
      </div>
    </div>
  `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2rem; padding: clamp(2rem, 4vw, 4rem);">
      ...
      <div class="rev d6" style="border-top: 1px solid var(--rule); padding-top: 1.2rem;">
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.2rem;">
          ${[
            ['PLAYER INTERVIEW SERIES',  'Host a video show with one player per episode — their story, their why, their journey. Fans get to know players personally.'],
            ['VETTA PARTNERSHIP',         'Cover their tournaments with our interns. Find new players for us. Build the Ambush brand in front of every youth family in town.'],
            ['AI ASSISTANTS',              'Build automated tools that write social posts, send fan emails, suggest ticket prices, and find new players — without adding staff.'],
            ['ORIGINAL RESEARCH',          'Publish soccer research under the Ambush name through the Footy Collective. Builds national credibility for the club.'],
            ['UNIVERSITY BROADCAST',       'Partner with SLU, Webster, Lindenwood, and Maryville to produce live game broadcasts using their students at no cost to us.'],
            ['ONE DATA SYSTEM',            'Connect everything — player wellness, GPS, ticket sales, fan emails — into one place so every decision is data-backed.'],
          ].map(([k, v]) => `
            <div>
              <div class="display" style="color: var(--teal); font-size: 0.95rem; letter-spacing: 0.04em; margin-bottom: 0.4rem;">${k}</div>
...
/* ============================================================
   39a — NEBRASKA FOOTBALL FACILITIES. Reference architecture.
   ============================================================ */
SLIDES.push({
  section: 'PART III · GAME DAY',
  ...
  cls: 'bg-paper',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART III · FACILITY REFERENCE')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <div class="eyebrow accent-pink">REFERENCE · NEBRASKA FOOTBALL</div>
          <div class="display display-lg" style="color: var(--ink); margin-top: 0.5rem;">What a real <span class="accent-pink">performance environment</span> looks like.</div>
        </div>
        <div class="mono" style="color: var(--mute-deep); text-align: right;">NOT THE BUDGET<br>THE BLUEPRINT</div>
      </div>

      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; align-content: center;">
        ${[
          {
            num: '01',
            title: 'FILM ROOM ON TURF',
            body: 'A horizontal room laid with turf and an elongated projector screen. Players don\'t just watch film — they walk through formations, set pieces, and tactical scenarios on the same surface they play on. Visualization meets muscle memory.'
          },
          {
            num: '02',
            title: 'NAP & RECOVERY PODS',
            body: 'Dedicated quiet spaces for players to crash after practice or recover between sessions. Sleep is a performance variable, not a luxury. Mid-day recovery is built into the day, not improvised.'
          },
          {
            num: '03',
            title: 'COLD INDOOR LAP POOL',
            body: 'Indoor pool with lap lanes intentionally kept cold. Active recovery in water — gets blood flowing, reduces inflammation, accelerates turnaround between training blocks. The recovery modality with the highest ROI per square foot.'
          },
        ].map(c => `
          <div style="border-top: 4px solid var(--pink); padding: 1.5rem 0; display: flex; flex-direction: column; gap: 1rem;">
            <div class="display" style="color: var(--pink); font-size: 2.4rem; line-height: 0.9;">${c.num}</div>
            <div class="display" style="color: var(--ink); font-size: 1.3rem; letter-spacing: 0.04em; line-height: 1.05;">${c.title}</div>
            <div class="serif" style="color: var(--mute-deep); font-size: 1rem; font-style: italic; line-height: 1.45;">${c.body}</div>
          </div>
        `).join('')}
      </div>

      <div class="rev d6" style="background: var(--ink); color: var(--paper); padding: 1.5rem 2rem;">
        <div style="display: grid; grid-template-columns: auto 1fr; gap: 1.5rem; align-items: center;">
          <div class="mono accent-pink" style="font-weight: 700;">▸ THE TAKEAWAY</div>
          <div class="serif" style="font-size: 1.2rem; font-style: italic; line-height: 1.35;">
            We don't have the budget. We can have the philosophy. <span class="accent-pink" style="font-style: normal; font-weight: 600;">A film space that doubles as a tactical walkthrough room. A quiet recovery zone. A cold-tub corner.</span> All achievable on an indoor-club budget — and all bigger differentiators than another marketing line item.
          </div>
        </div>
      </div>
    </div>
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div class="display display-lg" style="color: var(--paper);">The <span class="accent-pink">operational backbone.</span></div>
        <div class="mono accent-mute">TRAVEL · NUTRITION · MEDICAL · COMPLIANCE</div>
      </div>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2.5rem; align-content: center;">

        <div class="rev d2" style="padding: 2rem; border-left: 4px solid var(--teal);">
          <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 1.5rem;">
            <div class="display display-md accent-teal" style="font-size: 1.8rem;">CURRENT STANDARD</div>
            <div class="mono accent-mute">WORKING WELL</div>
          </div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['TRAVEL',       'Flights booked roughly 2 days out via Donnie'],
              ['ROAD MEALS',   'Food ordered day before — JJ\'s, Panera, or local equivalent'],
              ['REGIONAL BUS', 'Decaled team bus for Comets, Wave, Strykers; player snack packs prepped'],
              ['MATCHDAY KIT', 'Brian Wagner runs equipment turnover, jerseys hung pre-arrival'],
              ['MEDICAL',      'Cody Elmendorf travels with the team; basic in-season rehab on-site'],
              ['ROSTER FILING','Pre-match roster cards filed on time, no compliance fines'],
              ['INSURANCE',    'Player insurance and waivers up to date'],
            ].map(([k, v]) => `
              <div style="display: grid; grid-template-columns: 130px 1fr; gap: 1rem; padding: 0.7rem 0; border-top: 1px solid var(--rule); align-items: baseline;">
                <div class="display" style="color: var(--teal); font-size: 0.9rem; letter-spacing: 0.04em;">${k}</div>
                <div class="serif" style="color: var(--paper); font-size: 0.95rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
          </div>
        ...
        <div class="rev d3" style="padding: 2rem; border-left: 4px solid var(--pink);">
          <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 1.5rem;">
            <div class="display display-md accent-pink" style="font-size: 1.8rem;">OPPORTUNITIES</div>
            <div class="mono accent-pink" style="font-weight: 700;">SHARPENING</div>
          </div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['VENDOR PLAYBOOK',     'Travel + meal vendors researched at season start, locked by mid-week'],
              ['ITINERARY',           'Full road-trip itinerary distributed 72 hours pre-departure'],
              ['NUTRITION',           'Pre-game and post-match meals timed for performance — Pure Plates STL partnership'],
              ['HYDRATION',           'Personal water bottles per player, electrolyte protocol on the road'],
              ['SLEEP',               'Hotel block standardized, blackout curtain rule, late-arrival meal protocol'],
              ['REGISTRATION',        'Centralized player registration tracker with auto-reminders for renewals'],
              ['GAME-DAY OPS',        'Single shared travel checklist owned by the equipment manager'],
              ['POST-MATCH FILE',     'Travel debrief logged in 24 hours — what worked, what to adjust'],
            ].map(([k, v]) => `
              <div style="display: grid; grid-template-columns: 130px 1fr; gap: 1rem; padding: 0.7rem 0; border-top: 1px solid rgba(255,61,110,0.25); align-items: baseline;">
                <div class="display" style="color: var(--pink); font-size: 0.9rem; letter-spacing: 0.04em;">${k}</div>
                <div class="serif" style="color: var(--paper); font-size: 0.95rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
          </div>
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <div class="eyebrow accent-teal">FUTURE · MOBILE APP</div>
          <div class="display display-lg" style="color: var(--paper); margin-top: 0.5rem;">In every fan's <span class="accent-pink">pocket.</span></div>
        </div>
...
SLIDES.push({
  ...
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART IV · TICKETING MIGRATION PROPOSAL')}
    <div class="frame" style="grid-template-rows: auto auto 1fr auto; gap: 1.6rem; padding: clamp(2.5rem, 4vw, 4rem) clamp(3rem, 5vw, 5rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div class="display display-lg" style="color: var(--paper);">A <span class="accent-pink">staged</span> migration.</div>
        <div class="mono accent-mute">PILOT USL 2 · PROVE THE MODEL · PROPOSE TO FAMILY ARENA</div>
      </div>

      <!-- Constraint reality framing -->
      <div class="rev d2" style="background: rgba(244,241,234,0.04); border-left: 3px solid var(--paper); padding: 1rem 1.4rem;">
        <div class="serif" style="color: var(--paper); font-size: 1.05rem; font-style: italic; line-height: 1.4;">
          <span style="color: var(--paper); font-style: normal; font-weight: 700;">The reality:</span> Family Arena's master agreement requires Ticketmaster for indoor MASL home games. We can't unilaterally migrate. <span class="accent-pink" style="font-style: normal; font-weight: 600;">But we can pilot Jump on USL 2, prove the savings and the fan-data upside, then walk that case into the Family Arena conversation as the contract approaches renewal.</span>
        </div>
      </div>

      <!-- 4 phases as columns -->
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; align-items: stretch;">
        ${[
          { year: 'YEAR 1',  label: 'PILOT · USL 2 ONLY', color: 'var(--teal)',
            items: [
              'Migrate USL 2 outdoor season ticketing to Jump',
              'Target ~5% fee structure (vs. 15-25% on Ticketmaster)',
              'Branded checkout — Ambush colors, copy, journey',
              'Capture every buyer email + phone into our CRM',
              'Run dynamic pricing manually, weekly review',
              'Document the savings + fan-data upside',
            ] },
          { year: 'YEAR 2',  label: 'OPTIMIZE THE PILOT', color: 'var(--pink)',
            items: [
              'Tier USL 2 ticket prices by opponent + day-of-week',
              'Test student .edu program with Jump promo codes',
              'Auto-segment USL 2 buyers into MASL email funnel',
              'Run win-back, birthday, group-sales playbooks',
              'Build a one-page case for Family Arena leadership',
            ] },
          { year: 'YEAR 2-3',  label: 'PROPOSE TO FAMILY ARENA', color: 'var(--paper)',
            items: [
              'Walk in with two seasons of USL 2 data',
              'Quantified case: $140K-$170K saved per indoor season',
              'Show fan-data wins driving repeat purchase',
              'Propose Jump as approved alternate vendor',
              'Negotiate revenue share that protects Family Arena',
            ] },
          { year: 'YEAR 3+',  label: 'INDOOR MIGRATION',  color: 'var(--pink)',
            items: [
              'Indoor MASL home games on Jump',
              'Save $140K-$170K per season recurring',
              'Every indoor transaction = fan record we own',
              'Dynamic pricing live; loyalty program tied in',
              'Mobile app + ticketing fully integrated',
            ] },
        ].map(({ year, label, color, items }, i) => `
          <div class="rev d${i+3}" style="padding: 1.4rem 1.2rem; border-left: ${i>0 ? '1px solid var(--rule)' : 'none'}; display: flex; flex-direction: column; gap: 1rem;">
            <div>
              <div class="display" style="font-size: clamp(1.6rem, 2.2vw, 2rem); color: ${color}; line-height: 0.9;">${year}</div>
              <div class="mono" style="color: ${color}; opacity: 0.85; font-size: 0.65rem; letter-spacing: 0.18em; margin-top: 0.4rem;">${label}</div>
            </div>
            <div style="width: 100%; height: 2px; background: ${color};"></div>
            <div style="display: flex; flex-direction: column; gap: 0.55rem;">
              ${items.map(t => `
                <div style="display: grid; grid-template-columns: 8px 1fr; gap: 0.6rem; align-items: baseline;">
                  <div style="width: 5px; height: 5px; background: ${color}; margin-top: 0.45rem;"></div>
                  <div class="serif" style="color: var(--paper); font-size: 0.85rem; font-style: italic; line-height: 1.35;">${t}</div>
                </div>
              `).join('')}
            </div>
          </div>
      ...
      <div class="rev d7" style="background: var(--pink); color: var(--paper); padding: 1.1rem 1.6rem; display: flex; justify-content: space-between; align-items: center; gap: 1.5rem;">
        <div class="display" style="font-size: clamp(1.1rem, 1.7vw, 1.5rem); letter-spacing: 0.04em;">THE BET: PROVE IT ON USL 2 FIRST. THE FAMILY ARENA CASE GETS EASIER EVERY MONTH WE RUN IT.</div>
      </div>
    </div>
  `
});
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        ...
        <div class="mono accent-mute">REFERENCE: VERMONT GREEN · WREXHAM · KC CURRENT</div>
      </div>

      <div style="display: grid; grid-template-columns: 1fr 1.6fr; gap: 4rem; align-items: center;">
        <div class="rev d2">
          <div class="display" style="font-size: clamp(2.6rem, 5.5vw, 5.5rem); line-height: 0.9; color: var(--paper);">Brand is the<br>highest-<span class="accent-pink">ROI</span> lever<br>we have.</div>
          <div class="serif" style="color: var(--paper); font-size: 1.2rem; font-style: italic; margin-top: 1.5rem; line-height: 1.4;">
            In lower-division pro sports, <span class="accent-pink" style="font-style: normal; font-weight: 600;">brand work moves the needle further than payroll.</span>
          </div>
          <div class="serif" style="color: var(--mute); font-size: 1rem; font-style: italic; margin-top: 1rem; line-height: 1.45;">
            Wrexham, Vermont Green, and KC Current didn't out-spend their leagues — they out-designed them. Every kit drop, retro night, and crest moment compounds into a national audience that pays for tickets, merch, and sponsorship the league couldn't otherwise command.
          </div>
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.6rem 2rem; align-content: center;">
          ${[
            ['KIT CYCLE',           'Home/Away/Third on a predictable cadence — each drop is a merch window, a press cycle, a content moment.'],
            ['ALTERNATE KITS',      'Bosnian heritage kit · 30-year throwback · Kids Club kit. Limited runs, fan-voted designs, sellouts.'],
            ['RETRO NIGHTS',        'Once per season the team wears a historic kit; fans get a matching scarf giveaway with the ticket.'],
            ['CREST AUDIT',         'Modernize the mark without losing the red. Extend the brand book to USL 2 and FC Ambush Youth.'],
            ['STADIUM GRAPHICS',    'Tunnel, bench skirts, ice surface, jumbotron — every camera-facing surface as branded real estate.'],
            ['KIT LAUNCH CONTENT',  'Player-led reveal videos, community partner cameos, pre-season hype — built once, distributed everywhere.'],
          ].map(([t, d], i) => `
            <div class="rev d${Math.min(i+3, 8)}" style="padding: 1rem 0; border-top: 1px solid var(--rule);">
              <div class="display" style="color: var(--pink); font-size: 1.1rem; letter-spacing: 0.04em; margin-bottom: 0.4rem;">${t}</div>
              <div class="serif" style="color: var(--paper); font-size: 0.95rem; font-style: italic; line-height: 1.4;">${d}</div>
            </div>
          `).join('')}
        </div>
      ...
      <div class="rev d8" style="border-top: 1px solid var(--rule); padding-top: 1.2rem;">
        <div class="serif" style="color: var(--paper); font-size: 1.2rem; font-style: italic; text-align: center; line-height: 1.35;">
          You can't out-spend KC Comets on payroll. <span class="accent-pink" style="font-style: normal; font-weight: 600;">You can absolutely out-design them.</span>
        </div>
      </div>
    </div>
  `
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: grid; grid-template-columns: 240px 1fr 1fr; gap: 0; border-top: 2px solid var(--paper); border-bottom: 2px solid var(--paper); align-content: center;">
        <div style="padding: 1.2rem 1.5rem; border-right: 1px solid var(--rule); display: flex; align-items: center; justify-content: center;">
          <div class="mono accent-mute">STREAM</div>
        </div>
        <div style="padding: 1.2rem 1.5rem; border-right: 1px solid var(--rule); background: rgba(0,184,169,0.06); display: flex; align-items: center; justify-content: center;">
          <div class="mono accent-teal" style="font-weight: 700;">▸ CURRENT</div>
        </div>
        <div style="padding: 1.2rem 1.5rem; background: rgba(255,61,110,0.06); display: flex; align-items: center; justify-content: center;">
        ...
        ${[
          ...
          <div class="rev d${Math.min(i+2, 8)}" style="display: contents;">
            <div style="padding: 1.5rem 1.5rem; border-top: 1px solid var(--rule); border-right: 1px solid var(--rule); display: flex; align-items: center; justify-content: center; text-align: center;">
              <div class="display" style="color: var(--paper); font-size: 1.2rem; letter-spacing: 0.04em;">${stream}</div>
            </div>
            <div style="padding: 1.5rem 1.5rem; border-top: 1px solid var(--rule); border-right: 1px solid var(--rule); background: rgba(0,184,169,0.04); display: flex; align-items: center; justify-content: center; text-align: center;">
              <div class="serif" style="color: var(--paper); font-size: 1.05rem; font-style: italic; line-height: 1.4;">${cur}</div>
            </div>
            <div style="padding: 1.5rem 1.5rem; border-top: 1px solid var(--rule); background: rgba(255,61,110,0.04); display: flex; align-items: center; justify-content: center; text-align: center;">
              <div class="serif" style="color: var(--paper); font-size: 1.05rem; font-style: italic; line-height: 1.4;">${lever}</div>
            </div>
          </div>
        `).join('')}
      </div>
    ...
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2rem; padding: clamp(2rem, 4vw, 4rem); position: relative;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.2rem;">
        ${[
          ...
          ['KEY-PERSON ATTRITION',    'Jeff. Donnie. Shelly. Without investment, jobs expand, roles expand, and the same people start doing more — output ceiling holds while burnout risk rises.'],
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: flex; flex-direction: column; gap: 0; border-top: 2px solid var(--ink); border-bottom: 2px solid var(--ink); align-content: center; justify-content: center;">
        ${[
          ...
          ['02', 'PLATFORM FEE DRAIN',   '$100K–$170K per season leaving via Ticketmaster fees.',                                     'Addressable within 12–18 months via the USL 2 pilot. Highest-ROI infrastructure change available.'],
          ['03', 'LIMITED CAPITAL',      'Year 1 can\'t spend at a Year 3 budget.',                                                    'Sequence: start with zero-cost wins, use returns to fund the next tier, then repeat the cycle.'],
        ].map(([num, t, problem, fix], i) => `
          <div class="rev d${i+2}" style="display: grid; grid-template-columns: 130px 1.2fr 2fr; gap: 2.5rem; padding: 2rem 0; border-top: ${i > 0 ? '1px solid rgba(10,10,10,0.15)' : '0'}; align-items: center;">
            <div class="display" style="font-size: clamp(4rem, 6.5vw, 6.5rem); color: var(--pink); line-height: 0.85; text-align: center;">${num}</div>
            <div>
              <div class="display" style="color: var(--ink); font-size: clamp(1.4rem, 1.9vw, 1.9rem); letter-spacing: 0.04em; margin-bottom: 0.6rem; line-height: 1.05;">${t}</div>
              <div class="serif" style="color: var(--mute-deep); font-size: clamp(1.05rem, 1.2vw, 1.2rem); font-style: italic; line-height: 1.4;">${problem}</div>
            </div>
            <div style="padding: 1.4rem 1.5rem; background: var(--ink); color: var(--paper);">
              <div class="mono" style="color: var(--teal); font-weight: 700; margin-bottom: 0.5rem;">▸ TRAJECTORY</div>
              <div class="serif" style="font-size: 1.1rem; font-style: italic; line-height: 1.4;">${fix}</div>
            </div>
          </div>
        `).join('')}
      </div>
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2.5rem; align-items: start;">
        ...
        <!-- YEAR 1 -->
        <div class="rev d2" style="padding: 2.2rem; border: 1px solid var(--rule); background: rgba(0,184,169,0.05); display: flex; flex-direction: column; gap: 1.3rem;">
          <div class="mono accent-teal" style="font-weight: 700;">YEAR 1 · NET TICKET REVENUE</div>
          ...
          <div style="display: flex; flex-direction: column; gap: 0.7rem;">
            ${[
              ['ATTENDANCE',         'Average up to 2,800/game — World Cup-driven and a new student .edu program filling the upper bowl.'],
              ['USL 2 PILOT',         'Migrate USL 2 ticketing to Jump platform — first proof point for indoor case, $20K-$30K saved year one.'],
              ['DYNAMIC PRICING',     'Manual weekly review based on opponent, day-of-week, demand. Conservative 8-12% lift.'],
              ['STUDENT PROGRAM',     '$12 .edu tier launches with SLU, Webster, Lindenwood, Maryville. Fills late-arrival inventory.'],
              ['MERCH UPLIFT',        'Pre-season survey + themed limited drops drive merch revenue up 15-20% off a current low base.'],
            ].map(([k, v]) => `
              <div style="display: grid; grid-template-columns: 130px 1fr; gap: 0.9rem; align-items: baseline;">
                <div class="display" style="color: var(--teal); font-size: 0.85rem; letter-spacing: 0.04em;">${k}</div>
                <div style="font-family: var(--f-body); color: var(--paper); font-size: 0.88rem; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
          </div>
        </div>
        ...
        <!-- YEAR 3 -->
        <div class="rev d3" style="padding: 2.2rem; border: 2px solid var(--pink); background: rgba(255,61,110,0.08); display: flex; flex-direction: column; gap: 1.3rem;">
          <div class="mono accent-pink" style="font-weight: 700;">YEAR 3 · NET TICKET REVENUE</div>
          <div style="display: flex; align-items: baseline; gap: 1rem;">
          ...
          <div style="width: 100%; height: 1px; background: rgba(255,61,110,0.3);"></div>
          <div style="display: flex; flex-direction: column; gap: 0.7rem;">
            ${[
              ['ATTENDANCE',         'Average 3,500/game — roughly 70% of the lower bowl every night, every game.'],
              ['INDOOR ON JUMP',      'Family Arena migration complete — recurring $140K-$170K/season fee savings flow through to the bottom line.'],
              ['ANCHOR SPONSOR',      'Platinum-tier title or stadium-naming partner secured — $150K-$250K/yr commitment.'],
              ['MERCH +40%',          'Kit-cycle program, retro nights, and Kids Club at scale push merch revenue up 40%+.'],
              ['ANCILLARY LINE',      'Tailgate, Charity Classic, watch parties, off-season events become a real revenue line — not zero.'],
            ].map(([k, v]) => `
              <div style="display: grid; grid-template-columns: 130px 1fr; gap: 0.9rem; align-items: baseline;">
                <div class="display" style="color: var(--pink); font-size: 0.85rem; letter-spacing: 0.04em;">${k}</div>
                <div style="font-family: var(--f-body); color: var(--paper); font-size: 0.88rem; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
          </div>
...
SLIDES.push({
  ...
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART VI · CAPITAL & ENDORSEMENT')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <span class="chip pink">FUTURE · CAPITAL &amp; ENDORSEMENT</span>
        </div>
        <div class="display display-lg" style="color: var(--paper);">Who <span class="accent-pink">else</span><br>should have a stake?</div>
      </div>

      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2.5rem; align-items: start;">
        ${[
          {
            num: '01', t: 'LOCAL CELEBRITY ENDORSERS',
            d: 'Wrexham proved star power moves the needle in lower-division sport. St. Louis names with reach but accessibility:',
            list: [
              'Becky G or local Cardinals alumni for Hispanic / family reach',
              'Albert Pujols Foundation tie-in for credibility &amp; community',
              'Local podcast hosts (Bernie Miklasz, The Buzz) for STL sports media',
              'St. Louis-rooted college coaches with national profile',
            ],
            footer: 'The exchange: visible role, free seats, social moments, optional nominal equity stake.'
          },
          {
            num: '02', t: 'CITY SC GOODWILL PLAY',
            d: 'Comp tickets to St. Louis City SC players, staff, and front office. Soccer is one ecosystem in this town and visibility cuts both ways.',
            list: [
              'Free seats for active CITY SC roster + technical staff',
              'Dedicated Ambush night at CITY SC park (and vice versa)',
              'Shared content moments — players visiting each other\'s training',
              'Joint youth clinic — pro vs. indoor crossover for FC Ambush kids',
            ],
            footer: 'Costs us nothing. Earns visibility, photo opportunities, and joint-marketing leverage with the league\'s biggest local brand.'
          },
          {
            num: '03', t: 'MASL OPEN CUP',
            d: 'Cross-division indoor tournament — MASL vs MASL 2 vs MASL 3. May through August window when the league goes dark.',
            list: [
              'Open knockout format with seeded brackets',
              'Gate split 70/30 host/visitor',
              'Broadcast rights bundled and sold league-wide',
              'Press-friendly upsets drive new audience',
            ],
            footer: 'Full proposal ready for league leadership. Modeled on FA Cup-style cross-division upset narratives.'
          },
        ].map((c, i) => `
          <div class="rev d${i+2}" style="border-top: 4px solid var(--pink); padding: 1.5rem 0; display: flex; flex-direction: column; gap: 1rem;">
            <div class="display" style="color: var(--pink); font-size: 2.5rem; line-height: 0.9;">${c.num}</div>
            <div class="display" style="color: var(--paper); font-size: 1.25rem; letter-spacing: 0.04em; line-height: 1;">${c.t}</div>
            <div class="serif" style="color: var(--paper); font-size: 0.98rem; font-style: italic; line-height: 1.45;">${c.d}</div>
            <div style="display: flex; flex-direction: column; gap: 0.4rem;">
              ${c.list.map(item => `
                <div style="display: grid; grid-template-columns: 8px 1fr; gap: 0.7rem; align-items: baseline;">
                  <div style="width: 5px; height: 5px; background: var(--pink); margin-top: 0.5rem;"></div>
                  <div style="font-family: var(--f-body); color: var(--paper); font-size: 0.85rem; line-height: 1.4;">${item}</div>
                </div>
              `).join('')}
            </div>
            <div style="margin-top: auto; padding-top: 1rem; border-top: 1px solid var(--rule);">
              <div class="serif" style="color: var(--teal); font-style: italic; font-size: 0.9rem; line-height: 1.4;">${c.footer}</div>
            </div>
          </div>
        `).join('')}
      </div>

      <div class="rev d6" style="background: var(--pink); color: var(--paper); padding: 1.2rem 1.8rem;">
        <div class="serif" style="font-size: 1.2rem; font-style: italic; text-align: center; line-height: 1.3;">
          The Ambush doesn't need to chase capital. <span style="color: var(--ink); font-style: normal; font-weight: 700;">It needs to be worth being seen with.</span>
        </div>
      </div>
    </div>
  `
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 5rem; align-items: center;">
        <div class="rev d2">
          <div class="display" style="font-size: clamp(3.8rem, 9vw, 9rem); line-height: 0.85; color: var(--paper);">Embedded<br>intelligence.</div>
          <div class="serif" style="color: var(--ink); font-size: 1.7rem; font-style: italic; margin-top: 2.2rem; line-height: 1.2;">Not a report.<br>A presence.</div>
        </div>

        <div style="display: flex; flex-direction: column; gap: 0;">
          ${[
            ['INTEGRATION',  'The role doesn\'t need a new title. It needs to live inside every meeting.'],
            ['PROACTIVE',     'Opposition reports two weeks out. Wellness live before training. Recruitment database always current.'],
            ['AUTOMATED',     'AI assistants distribute match reports, log receipts, trigger pricing alerts, personalize campaigns.'],
            ['COMPOUNDING',   'Every season of data makes the next decision better. The infrastructure pays itself back.'],
            ['SCALE',         'Enhancements at 3 to 10× current scope — practice data, personalized reports, league-wide context.'],
          ].map(([k, v], i) => `
            <div class="rev d${Math.min(i+3, 8)}" style="display: grid; grid-template-columns: 220px 1fr; gap: 1.5rem; padding: 1.3rem 0; border-top: 1px solid rgba(244,241,234,0.35); align-items: center;">
              <div class="display" style="color: var(--ink); font-size: 1.3rem; letter-spacing: 0.05em; line-height: 1;">${k}</div>
              <div class="serif" style="color: var(--paper); font-size: 1.25rem; font-style: italic; line-height: 1.4;">${v}</div>
            </div>
          `).join('')}
          <div style="border-top: 1px solid rgba(244,241,234,0.35);"></div>
        </div>
      </div>
    </div>
  `
...
SLIDES.push({
  ...
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART VII · WHY ME, WHY NOW')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <div class="eyebrow accent-pink">WHY ME, WHY NOW</div>
          <div class="display display-lg" style="color: var(--paper); margin-top: 0.5rem;">Why <span class="accent-pink">expand</span><br>my role.</div>
        </div>
        <div class="mono accent-mute" style="text-align: right; max-width: 32ch;">FIVE REASONS · FIVE THINGS I'D START WEEK ONE</div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
        ...
        <!-- LEFT: Why me -->
        <div class="rev d2">
          <div class="display" style="color: var(--teal); font-size: 1.4rem; letter-spacing: 0.04em; margin-bottom: 1.5rem;">▸ FIVE REASONS</div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['ALREADY DOING THE WORK',
                'Most of what an expanded role looks like is already happening — without a title, formal mandate, or matching budget.'],
              ['DUAL FLUENCY',
                'I sit at the intersection of soccer and data. That mix is rare in MASL and rarer at our payroll level.'],
              ['INSTITUTIONAL TRUST',
                'I\'ve earned the locker room, the coaching staff, and ownership\'s comfort. Onboarding is already done.'],
              ['MULTIPLIER MINDSET',
                'I build tools other people use — interns, coaches, ownership. One hire creates leverage across every department.'],
              ['LOCAL ROOTS',
                'I live here. I\'m staying here. The Ambush is my long game, not a stepping stone.'],
            ].map(([k, v]) => `
              <div style="padding: 0.85rem 0; border-top: 1px solid var(--rule);">
                <div class="display" style="color: var(--paper); font-size: 1rem; letter-spacing: 0.04em; margin-bottom: 0.3rem;">${k}</div>
                <div class="serif" style="color: var(--mute); font-size: 0.92rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
            <div style="border-top: 1px solid var(--rule);"></div>
          </div>
        ...
        <!-- RIGHT: What I'd start doing -->
        <div class="rev d3">
          <div class="display" style="color: var(--pink); font-size: 1.4rem; letter-spacing: 0.04em; margin-bottom: 1.5rem;">▸ WHAT I'D START</div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['WEEK ONE',
                'Stand up the player profile interview series — first episode shot and edited within 30 days.'],
              ['WEEK TWO',
                'Walk into the Vetta conversation with the full proposal in hand and an intern team ready to staff their next tournament.'],
              ['MONTH ONE',
                'Migrate USL 2 ticketing to Jump as the pilot — branded checkout, first fan emails captured, savings tracked.'],
              ['MONTH TWO',
                'Build the AI operations layer — content, CRM, pricing, scouting agents — and run them through a full home-game cycle.'],
              ['ONGOING',
                'Be in the building, in the meetings, in the locker room — every Saturday, every owner conversation, every sponsor pitch.'],
            ].map(([k, v]) => `
              <div style="padding: 0.85rem 0; border-top: 1px solid rgba(255,61,110,0.25);">
                <div class="display" style="color: var(--pink); font-size: 1rem; letter-spacing: 0.04em; margin-bottom: 0.3rem;">${k}</div>
                <div class="serif" style="color: var(--paper); font-size: 0.92rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
            <div style="border-top: 1px solid rgba(255,61,110,0.25);"></div>
          </div>
      ...
      <div class="rev d7" style="border-top: 2px solid var(--paper); padding-top: 1.5rem;">
        <div class="serif" style="font-size: 1.3rem; color: var(--paper); font-style: italic; text-align: center; line-height: 1.35;">
          Expanded scope isn't a bet. <span class="accent-pink" style="font-style: normal; font-weight: 600;">It's an extension of what's already working.</span>
        </div>
      </div>
    </div>
  `
...
/* ============================================================
   85a — SPORTS STARTUPS 2025. Jump case study + outreach.
   ============================================================ */
SLIDES.push({
  section: 'PART VII · ROADMAP',
  title: 'Sports Startups',
  cls: 'bg-ink',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART VII · INDUSTRY')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <span class="chip teal">PROACTIVE · INDUSTRY OUTREACH</span>
          <div class="display display-lg" style="color: var(--paper); margin-top: 1rem;">The class of <span class="accent-teal">2025.</span></div>
        </div>
        <div class="mono accent-mute" style="text-align: right; line-height: 1.5;">EARLY-STAGE COMPANIES<br>HUNGRY FOR CASE STUDIES</div>
      </div>

      <div style="display: grid; grid-template-columns: 1.1fr 1fr; gap: 3rem; align-items: center;">

        <!-- LEFT: Jump case study -->
        <div class="rev d2" style="border: 2px solid var(--teal); background: rgba(0,184,169,0.08); padding: 2rem; display: flex; flex-direction: column; gap: 1.3rem;">
          <div style="display: flex; align-items: baseline; justify-content: space-between;">
            <div class="display accent-teal" style="font-size: 1.7rem; letter-spacing: 0.05em;">▸ CASE STUDY · JUMP</div>
            <div class="mono accent-mute">FOUNDED 2025</div>
          </div>
          <div class="serif" style="color: var(--paper); font-size: 1.25rem; font-style: italic; line-height: 1.4;">
            Jump is a ticketing platform built for clubs that want fan ownership of the transaction. <span class="accent-teal" style="font-style: normal; font-weight: 700;">~5% fees vs. Ticketmaster's 15-25%.</span> Branded checkout, full fan-data ownership, dynamic pricing native.
          </div>
          <div style="border-top: 1px solid rgba(0,184,169,0.3); padding-top: 1rem;">
            <div class="mono accent-teal" style="font-weight: 700; margin-bottom: 0.6rem;">WHY THEY WANT US</div>
            <div class="serif" style="color: var(--paper); font-size: 1.05rem; font-style: italic; line-height: 1.4;">
              They need indoor case studies. We need a USL 2 pilot platform. <span class="accent-teal" style="font-style: normal; font-weight: 700;">Mutual incentive.</span> Early-stage companies trade favorable terms for visibility and learning — they're not in extraction mode yet.
            </div>
          </div>
        </div>
        ...
        <!-- RIGHT: Other targets -->
        <div class="rev d3">
          <div class="display accent-pink" style="font-size: 1.5rem; letter-spacing: 0.05em; margin-bottom: 1.2rem;">▸ OTHER TARGETS</div>
          <div style="display: flex; flex-direction: column; gap: 0;">
            ${[
              ['SCOUTING & RECRUITMENT',  'Wyscout-style platforms for lower-division and indoor — most ignore MASL today, and that\'s the opening.'],
              ['WEARABLES',                'Catapult competitors with friendlier indoor-team pricing. We become their case study, they become our load-management spine.'],
              ['VIDEO ANALYSIS',           'Hudl alternatives with AI auto-tagging — the indoor coding market is wide open.'],
              ['CRM / FAN DATA',            'Klaviyo-for-sports stacks looking for a club willing to actually use the platform end-to-end.'],
              ['AI CONTENT',                'Highlight-generation, social-cut, and broadcast-graphic startups starving for league-level partners.'],
            ].map(([k, v]) => `
              <div style="padding: 0.8rem 0; border-top: 1px solid var(--rule);">
                <div class="display" style="color: var(--paper); font-size: 0.95rem; letter-spacing: 0.04em; margin-bottom: 0.3rem;">${k}</div>
                <div class="serif" style="color: var(--mute); font-size: 0.92rem; font-style: italic; line-height: 1.4;">${v}</div>
              </div>
            `).join('')}
      ...
      <div class="rev d6" style="border-top: 2px solid var(--teal); padding-top: 1.2rem; display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
        <div class="mono accent-teal" style="font-weight: 700;">▸ THE PUSH</div>
        <div class="serif" style="color: var(--paper); font-size: 1.15rem; font-style: italic; line-height: 1.35;">
          Get them to <span class="accent-teal" style="font-style: normal; font-weight: 600;">adapt to the indoor game</span> — court dimensions, kick-ins, indoor-specific event types. Most are built for outdoor first; we become the partner that earns them indoor-market presence in exchange for a tailored product. I take the cold outreach. You take the meetings.
        </div>
      </div>
    </div>
  `
...
/* ============================================================
   85b — BEARS / DELOITTE LESSONS. Industry intel from inside friend.
   ============================================================ */
SLIDES.push({
  section: 'PART VII · ROADMAP',
  ...
  cls: 'bg-paper',
  render: (n, total) => `
    ${edgeChrome(n, total, 'PART VII · INDUSTRY INTEL')}
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 2.5rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">

      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        <div>
          <div class="eyebrow accent-pink">INDUSTRY INTEL · BEARS &amp; DELOITTE</div>
          <div class="display display-lg" style="color: var(--ink); margin-top: 0.5rem;">Where the <span class="accent-pink">big leagues</span> are heading.</div>
        </div>
        <div class="mono" style="color: var(--mute-deep); text-align: right; line-height: 1.5;">VIA A BUDDY EMBEDDED<br>WITH THE CHICAGO BEARS</div>
      </div>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; align-content: center;">
        ${[
          ['01', 'PRESCRIPTIVE OVER DESCRIPTIVE',
            'Teams don\'t want another dashboard with charts. They want the system to tell them what to do — AI/ML running on integrated data, surfacing decisions, not just statistics. The dashboard era is ending.'],
          ['02', 'ONE SYSTEM, NOT A DOZEN',
            'The next generation of clubs combines tracking data, wearables, video analysis, and medical records into one system. Twelve disconnected tools is the past. One integrated layer is the future.'],
          ['03', 'ALWAYS-ON WEARABLES',
            'Sleep, nutrition, hydration, mental load — what the player does outside practice now matters as much as what they do during it. Always-on wearables make this visible. The clubs who measure it win the recovery battle.'],
          ['04', 'AVAILABILITY AS THE KPI',
            'Player availability rate and return-to-play time are how the Bears justify every six-figure investment to ownership. If we can\'t measure availability, we can\'t justify a sport-science line. If we can, the case writes itself.'],
        ].map(([num, k, v]) => `
          <div style="border-top: 4px solid var(--pink); padding: 1.5rem 0; display: flex; flex-direction: column; gap: 0.9rem;">
            <div class="display" style="color: var(--pink); font-size: 2.4rem; line-height: 0.9;">${num}</div>
            <div class="display" style="color: var(--ink); font-size: 1.25rem; letter-spacing: 0.04em; line-height: 1.05;">${k}</div>
            <div class="serif" style="color: var(--mute-deep); font-size: 1rem; font-style: italic; line-height: 1.45;">${v}</div>
          </div>
        `).join('')}
      </div>

      <div class="rev d6" style="background: var(--ink); color: var(--paper); padding: 1.5rem 2rem; display: grid; grid-template-columns: auto 1fr; gap: 2rem; align-items: center;">
        <div>
          <div class="mono accent-teal" style="font-weight: 700; margin-bottom: 0.3rem;">▸ THE BEARS\' BET</div>
          <div class="display" style="color: var(--paper); font-size: 1.4rem; letter-spacing: 0.04em; line-height: 1;">SPRINT.AI + ZONE7</div>
        </div>
        <div class="serif" style="font-size: 1.1rem; font-style: italic; line-height: 1.4;">
          The Bears identified Sprint.AI and Zone7 as the best path forward — prescriptive sport-science platforms that fold tracking, wearables, and medical data into single recommendations. <span class="accent-pink" style="font-style: normal; font-weight: 600;">Worth a hard look for the Ambush at our scale</span> — same logic, smaller deployment, friendlier pricing for early adopters.
        </div>
      </div>
    </div>
  `
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div class="rev d1" style="display: flex; justify-content: space-between; align-items: baseline;">
        ...
        <div class="serif accent-mute" style="font-size: 1.3rem; font-style: italic; max-width: 30ch; text-align: right; line-height: 1.3;">Ongoing discussion.<br>This is my suggested path.</div>
      </div>

      <div style="display: flex; flex-direction: column; gap: 0; border-top: 2px solid var(--rule); border-bottom: 2px solid var(--rule); align-content: center; justify-content: center;">
        ${[
          ['START AT THE YOUTH BASE',     'Secure 3-5 additional women\'s teams at FC Ambush before any pro-side conversation begins.'],
          ['BUILD THE CONVERSION FUNNEL', 'Larger youth participation creates the natural pipeline of demand and players for what comes next.'],
          ['THEN OPEN THE PRO DOOR',       'From there, the pro-side discussion can begin — backed by St. Louis women\'s soccer demand data.'],
          ['OPEN QUESTIONS',                'Same coaching staff or separate? Shared facility? Schedule overlap with the men\'s side?'],
        ].map(([k, v], i) => `
          <div class="rev d${i+2}" style="display: grid; grid-template-columns: 110px 1.2fr 1.6fr; gap: 2rem; padding: 1.7rem 0; border-top: ${i > 0 ? '1px solid var(--rule)' : '0'}; align-items: center;">
            <div class="display" style="color: var(--pink); font-size: clamp(2.6rem, 4vw, 3.8rem); line-height: 0.85; text-align: center;">${String(i+1).padStart(2,'0')}</div>
            <div class="display" style="color: var(--paper); font-size: clamp(1.2rem, 1.6vw, 1.55rem); letter-spacing: 0.04em; line-height: 1.05;">${k}</div>
            <div class="serif" style="color: var(--mute); font-size: clamp(1.1rem, 1.25vw, 1.3rem); font-style: italic; line-height: 1.4;">${v}</div>
          </div>
        `).join('')}
      </div>
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr auto; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
        ...
        <div class="rev d2" style="padding: 2.5rem; border: 2px solid var(--teal); background: rgba(0,184,169,0.05);">
          <div class="display accent-teal" style="font-size: 1.8rem; letter-spacing: 0.04em; margin-bottom: 1.5rem;">WHAT WE GIVE</div>
          ${[
            ...
            <div style="display: grid; grid-template-columns: 14px 1fr; gap: 0.9rem; padding: 0.95rem 0; border-top: 1px solid rgba(0,184,169,0.25); align-items: baseline;">
              <div style="width: 8px; height: 8px; background: var(--teal); margin-top: 0.55rem;"></div>
              <div class="serif" style="color: var(--paper); font-size: 1.2rem; font-style: italic; line-height: 1.4;">${s}</div>
            </div>
          `).join('')}
        </div>

        <div class="rev d3" style="padding: 2.5rem; border: 2px solid var(--pink); background: rgba(255,61,110,0.08);">
          <div class="display accent-pink" style="font-size: 1.8rem; letter-spacing: 0.04em; margin-bottom: 1.5rem;">WHAT WE GET</div>
          ${[
            ...
            <div style="display: grid; grid-template-columns: 14px 1fr; gap: 0.9rem; padding: 0.95rem 0; border-top: 1px solid rgba(255,61,110,0.25); align-items: baseline;">
              <div style="width: 8px; height: 8px; background: var(--pink); margin-top: 0.55rem;"></div>
              <div class="serif" style="color: var(--paper); font-size: 1.2rem; font-style: italic; line-height: 1.4;">${s}</div>
            </div>
          `).join('')}
        </div>
      ...
      <div class="rev d6" style="border-top: 2px solid var(--rule); padding-top: 1.2rem;">
        <div class="mono accent-mute" style="font-size: 0.95rem; text-align: center; letter-spacing: 0.18em;">
          TARGET PARTNERS · SLU (BILLIKEN BROADCAST NETWORK) · WEBSTER (FILM PROD) · LINDENWOOD (DIGITAL MEDIA) · MARYVILLE (SPORTS BROADCASTING)
        </div>
      </div>
    </div>
  `
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
        ...
        <div class="rev d2" style="padding: 2.5rem; border: 2px solid var(--pink); background: rgba(255,61,110,0.05);">
          <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 2rem;">
            <div class="display" style="color: var(--pink); font-size: 2.6rem; line-height: 0.9;">DAYS 1-30</div>
            <div class="mono accent-mute">FOUNDATION</div>
          </div>
          ${[
            'Game-day + set-piece playbook written and tested',
            'MASL compliance calendar built and shared',
            'Player appearance assignment calendar built and shared',
            'Press release distribution list established',
            'Pre-season merchandise survey launched',
          ].map((s, i) => `
            <div style="display: grid; grid-template-columns: 50px 1fr; gap: 1rem; padding: 0.95rem 0; border-top: 1px solid rgba(255,61,110,0.25); align-items: baseline;">
              <div class="display" style="color: var(--pink); font-size: 1.4rem; line-height: 0.9;">${String(i+1).padStart(2,'0')}</div>
              <div class="serif" style="color: var(--paper); font-size: 1.15rem; font-style: italic; line-height: 1.4;">${s}</div>
            </div>
          `).join('')}
        </div>

        <div class="rev d3" style="padding: 2.5rem; border: 2px solid var(--teal); background: rgba(0,184,169,0.05);">
          <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 2rem;">
            <div class="display" style="color: var(--teal); font-size: 2.6rem; line-height: 0.9;">DAYS 31-60</div>
          ...
          ${[
            ...
            <div style="display: grid; grid-template-columns: 50px 1fr; gap: 1rem; padding: 0.95rem 0; border-top: 1px solid rgba(0,184,169,0.25); align-items: baseline;">
              <div class="display" style="color: var(--teal); font-size: 1.4rem; line-height: 0.9;">${String(i+1).padStart(2,'0')}</div>
              <div class="serif" style="color: var(--paper); font-size: 1.15rem; font-style: italic; line-height: 1.4;">${s}</div>
            </div>
          `).join('')}
        </div>
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 5rem; align-items: center;">
        <div class="rev d2">
          <div class="display" style="font-size: clamp(4.5rem, 11vw, 11rem); line-height: 0.85; color: var(--paper);">DAYS<br><span style="color: var(--ink);">61-90.</span></div>
          <div class="serif" style="color: var(--paper); font-size: 1.7rem; font-style: italic; margin-top: 2rem; line-height: 1.25;">Pre-season locked.<br>Opening night ready.</div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 0;">
          ${[
            ...
            <div class="rev d${i+3}" style="display: grid; grid-template-columns: 80px 1fr; gap: 1.5rem; padding: 1.7rem 0; border-top: 1px solid rgba(244,241,234,0.35); align-items: center;">
              <div class="display" style="color: var(--ink); font-size: 2rem; line-height: 0.85;">${String(i+1).padStart(2,'0')}</div>
              <div class="serif" style="color: var(--paper); font-size: 1.3rem; font-style: italic; line-height: 1.4;">${s}</div>
            </div>
          `).join('')}
          <div style="border-top: 1px solid rgba(244,241,234,0.35);"></div>
        </div>
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: flex; flex-direction: column; gap: 0; border-top: 2px solid var(--rule); border-bottom: 2px solid var(--rule); align-content: center; justify-content: center;">
        ${[
          ...
          <div class="rev d${i+2}" style="display: grid; grid-template-columns: 240px 1fr; gap: 2.5rem; padding: 1.7rem 0; border-top: ${i > 0 ? '1px solid var(--rule)' : '0'}; align-items: center;">
            <div class="display" style="color: var(--pink); font-size: clamp(1.6rem, 2.2vw, 2.1rem); letter-spacing: 0.04em; line-height: 1;">${label}</div>
            <div class="serif" style="color: var(--paper); font-size: clamp(1.15rem, 1.35vw, 1.4rem); font-style: italic; line-height: 1.45;">${d}</div>
          </div>
        `).join('')}
      </div>
    </div>
...
SLIDES.push({
  ...
  render: (n, total) => `
    ...
    <div class="frame" style="grid-template-rows: auto 1fr; gap: 3rem; padding: clamp(3rem, 5vw, 5rem) clamp(4rem, 7vw, 8rem);">
      ...
      <div style="display: flex; flex-direction: column; gap: 0; border-top: 2px solid var(--ink); border-bottom: 2px solid var(--ink); align-content: center; justify-content: center;">
        ${[
          ['SPORTING',    'Full S&amp;C and sport-science staff in place. Unified tactical identity threading youth → USL 2 → first team. Three full seasons of GPS, wellness, and Catapult data. At least one Ron Newman Cup Final appearance under our belt.'],
          ['FAN BASE',    'Average attendance consistently above 3,000 — roughly 70% of the lower bowl every game. Kids Club 250+ active families. Mobile app with measurable loyal user base. World Cup-acquired fans retained and re-purchasing.'],
          ['COMMERCIAL',  'Tiered sponsor portfolio with 80%+ renewal rates. Platinum anchor partner secured at $150K-$250K/yr. Indoor ticketing migrated to Jump on Family Arena terms. Merchandise revenue up 40%+ off the launch baseline.'],
          ['COMMUNITY',   'Annual community impact report distributed to city, sponsors, and press. Formal school district partnerships in St. Charles County. Charity Classic established as a tentpole annual event. Three years of impact data backing every venue and city conversation.'],
        ].map(([label, d], i) => `
          <div class="rev d${i+2}" style="display: grid; grid-template-columns: 240px 1fr; gap: 2.5rem; padding: 1.7rem 0; border-top: ${i > 0 ? '1px solid rgba(10,10,10,0.25)' : '0'}; align-items: center;">
            <div class="display" style="color: var(--paper); font-size: clamp(1.6rem, 2.2vw, 2.1rem); letter-spacing: 0.04em; line-height: 1;">${label}</div>
            <div class="serif" style="color: var(--ink); font-size: clamp(1.15rem, 1.35vw, 1.4rem); font-style: italic; line-height: 1.45;">${d}</div>
          </div>
        `).join('')}
      </div>
    </div>
