...
const slideChrome = (n, total, section = 'ELEVATING THE AMBUSH') => `
...
SLIDES.push({
  title: 'Purpose',
  render: (n, total) => `
    ${slideChrome(n, total, 'INTRODUCTION')}
    ${watermark(n)}
...
SLIDES.push({
  title: 'Mission',
  render: (n, total) => `
    ${slideChrome(n, total, 'PART I &middot; EXECUTIVE OVERVIEW')}
    ${watermark(n)}
    <div class="slide-inner">
...
SLIDES.push({
  ...
  render: (n, total) => `
    ${slideChrome(n, total, 'PART II &middot; SPORTING')}
    ${watermark(n)}
    <div class="slide-inner">
...
SLIDES.push({
  ...
  render: (n, total) => `
    ${slideChrome(n, total, 'PART III &middot; GAME DAY')}
    ${watermark(n)}
    <div class="slide-inner">
...
SLIDES.push({
  ...
  render: (n, total) => `
    ${slideChrome(n, total, 'PART IV &middot; MARKETING')}
    ${watermark(n)}
    <div class="slide-inner">
      <div class="kicker reveal reveal-1"><span class="dot"></span>CURRENT STATE</div>
...
SLIDES.push({
  ...
  render: (n, total) => `
    ${slideChrome(n, total, 'PART V &middot; COMMUNITY')}
    ${watermark(n)}
    <div class="slide-inner">
      <div class="kicker reveal reveal-1"><span class="dot"></span>CURRENT STATE</div>
...
SLIDES.push({
  ...
  render: (n, total) => `
    ${slideChrome(n, total, 'PART VI &middot; FINANCE')}
    ${watermark(n)}
    <div class="slide-inner">
...
SLIDES.push({
  title: 'Current Role',
  render: (n, total) => `
    ${slideChrome(n, total, 'PART VII &middot; ROADMAP')}
    ${watermark(n)}
    <div class="slide-inner">
